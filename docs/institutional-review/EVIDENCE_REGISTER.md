...
- **Security whitepaper and architecture — `docs`:** authority: AND-164. Reconcile the exact published Security and Architecture revision with the deployed boundary. Share gate: security/privacy review.
...
- **PIA, retention, and privacy workflows — `docs/governance/privacy`:** authority: AND-157. Legal-policy drafts need human/legal approval wherever marked. Share gate: privacy/legal review.
...
- **AI/MCP permissions — developer/security docs plus `ai`:** authority: AND-113 / AND-164 inputs. Exact-head cross-repository delegated-data and permission reconciliation is required. Share gate: security/privacy review.
