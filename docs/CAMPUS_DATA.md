...
Canonical public UTM campus facts, geometry, routing graph inputs, provenance, and data-maintenance guidance live in [`andrewmuratov/gapwise-data`](https://github.com/andrewmuratov/gapwise-data).
