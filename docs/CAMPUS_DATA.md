...
Do not add new source-of-truth campus facts or public data documentation here. Change canonical campus facts in `Gapwise-for-UTM/data`, run the consumer sync once, and change released public documentation in `gapwise-docs`.
