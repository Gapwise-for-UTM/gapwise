...
Canonical public UTM campus facts, geometry, routing graph inputs, provenance, and data-maintenance guidance live in [`Gapwise-for-UTM/data`](https://github.com/Gapwise-for-UTM/data).
...
Do not add new source-of-truth campus facts or public data documentation here. Change canonical campus facts in [`data`](https://github.com/Gapwise-for-UTM/data), and change released public documentation in [`docs`](https://github.com/Gapwise-for-UTM/docs).
