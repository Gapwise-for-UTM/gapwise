...
- `13736687034` — `entrance=main` — `[-79.6656006, 43.5509053]` — exact OSM topology: pedestrian way `1499474239`; footway `1499491685`; way `1500142666`; indoor corridor `1500298510`. Held back because it is not a member of MN's named building way; `main` + proximity/corridor topology does not prove MN identity.
- `13736687041` — `entrance=main` — `[-79.6662061, 43.5510741]` — exact OSM topology: footway `1500122686`; ways `1500122688`, `1500149686`, `1507392979`; indoor corridor `1500298513`. Held back because it is not a member of MN's named building way; `main` + proximity/corridor topology does not prove MN identity.
...
- `2383656944` — `[-79.6632279, 43.5502743]` — exact OSM topology: building way `1127621275`; way `1149032682`. Unmatched; preserve as a real OSM door candidate, but do not assign a building.
- `10307744174` — `[-79.6631071, 43.5504326]` — exact OSM topology: footway `160783313`; way `1127621274`; building way `1127621275`; indoor corridor `1127621752`. Unmatched; corridor/footway membership does not establish building identity.
- `10309718335` — `[-79.6632161, 43.5504459]` — exact OSM topology: footway `1127388383`; way `1127621273`; building way `1127621275`; indoor corridor `1127621752`. Unmatched; corridor/footway membership does not establish building identity.
