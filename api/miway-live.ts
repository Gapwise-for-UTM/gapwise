...
// A deliberately bounded view around UTM. Arrivals can be farther away, but only nearby
// vehicles are sent to the browser so the map layer stays tiny and campus-focused.
const LIVE_BOUNDS = {
  west: -79.72,
  east: -79.58,
  south: 43.5,
