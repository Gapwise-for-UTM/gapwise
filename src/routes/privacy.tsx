    ...
    <LegalPage eyebrow="Privacy" title="Your schedule stays yours." date="August 30, 2026">
      ...
      <section>
        ...
        <p>
          ...
          metadata; Vercel remains inside the cryptographic trust boundary for the key-broker service.
        </p>
        <p>
      ...
      <section>
        ...
        <p>
          ...
          lossy availability information needed to provide mutual common-gap results. The availability
          capsule excludes course names, rooms, buildings, activity labels, and the full timetable.
          Time-bounded crowd reports and publisher state may also be stored when those community
          features are used.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          timetable. You choose supported read categories and separate write permissions. A minimized
          delegated snapshot may be processed by the Gapwise AI service and, when you invoke an AI
          provider, by that provider under its own terms and privacy practices. Gapwise does not send
          friend data, precise live location, primary private-data encryption keys, or identity-provider
          tokens in the delegated snapshot.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          technical, account, or delegated data. Those providers can process information outside your
          province or country. Exact production regions, provider retention, contractual terms, and
          legal roles can change and require provider-level verification rather than assumptions from
          source code alone.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Browser data remains until you replace it, remove it in Gapwise, or clear this site's data.
          Current cloud records generally remain until replaced or deleted, or until the account is
          deleted, subject to provider logs, backups, and other infrastructure retention outside the
        ...
        <p>
          Clearing browser data does not itself delete an existing cloud account or data already sent
          to an external AI provider. Provider-side backup and log deletion can also follow the
      ...
      <section>
        ...
        <p>
          ...
          Gapwise while travelling in another country does not by itself determine which law applies.
          Where applicable, you may have rights to ask about data Gapwise holds, request access or
          correction, object or withdraw consent for optional processing, or request deletion or
          portability.
        </p>
        <p>
          Self-service deletion and feature controls are available in the product. For a request that
          cannot be completed in the product, contact the repository owner through the{" "}
          <a href="https://github.com/andrewmuratov">Gapwise GitHub profile</a> and ask for a private
          privacy-request channel. Do not place personal information or account evidence in a public
          GitHub issue. A dedicated monitored privacy contact and accountable privacy role are still
          administrative items that require owner confirmation.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          response process. No security measure eliminates all risk. Suspected vulnerabilities should
          be reported through the private process on the <a href="/security">Security page</a>.
        </p>
        <p>
          If a privacy incident occurs, Gapwise's incident process requires scope and risk assessment
          before any notification decision. Applicable reporting, notice, recordkeeping, and timing
          duties depend on the jurisdiction and incident facts and require qualified review rather
          than a universal fixed deadline.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          The repository's <a href="https://github.com/andrewmuratov/gapwise/blob/main/PRIVACY.md">technical privacy notice</a>{" "}
          and <a href="https://github.com/andrewmuratov/gapwise/blob/main/docs/TRUST_DATA_INVENTORY.md">data inventory</a>{" "}
          document implementation details and known verification gaps. Material data-handling changes
          should be reflected in this notice before the changed behavior is promoted to users.
        </p>
      </section>
    </LegalPage>
  );
